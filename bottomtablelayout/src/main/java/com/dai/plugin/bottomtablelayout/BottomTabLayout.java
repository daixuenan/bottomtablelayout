package com.dai.plugin.bottomtablelayout;
...
import com.dai.plugin.bottomtablelayout.utils.AnimationUtils;
import com.dai.plugin.bottomtablelayout.utils.ThemeUtils;
        ...
        private void updateTextAndIcon(@Nullable final TextView textView,
            ...
            if (iconView != null) {
                if (icon != null) {
                    ...
                    Glide.with(getContext()).load(iconUrl).into(iconView);
                    iconView.setVisibility(VISIBLE);
                    setVisibility(VISIBLE);
                } else {
